 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.trader.trader.impl.LoopStatementImpl#getCount <em>Count</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.trader.trader.impl.LoopStatementImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LoopStatementImpl extends StatementImpl implements LoopStatement
{
  ...
  {
    return TraderPackage.Literals.LOOP_STATEMENT;
  }
  ...
  public NotificationChain basicSetCount(NumExpression newCount, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TraderPackage.LOOP_STATEMENT__COUNT, oldCount, newCount);
  ...
  public void setCount(NumExpression newCount)
  {
    if (newCount != count)
    {
      ...
      if (count != null)
        msgs = ((InternalEObject)count).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TraderPackage.LOOP_STATEMENT__COUNT, null, msgs);
      if (newCount != null)
        msgs = ((InternalEObject)newCount).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TraderPackage.LOOP_STATEMENT__COUNT, null, msgs);
      msgs = basicSetCount(newCount, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TraderPackage.LOOP_STATEMENT__COUNT, newCount, newCount));
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, TraderPackage.LOOP_STATEMENT__STATEMENTS);
    }
    return statements;
  }
